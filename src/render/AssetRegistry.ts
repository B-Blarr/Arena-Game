...
export class AssetRegistry {
  ...
  dispose(): void {
    const geos: BufferGeometry[] = [
      ...
      this.geoTetrahedron,
      this.geoSphere,
      this.geoPlayerProjectile,
      this.geoEnemyProjectile,
      this.geoCore,
      this.geoHeart,
      this.geoMagnet,
      this.geoOrb,
      ...
      this.geoPlayerBody,
      this.geoPlayerRing,
      this.geoTelegraphLine,
      this.geoIcosahedron,
      this.geoCapsule,
      this.geoBeam,
      this.geoStreak,
      this.geoTorusBoss,
      this.geoHeroDartHull,
      this.geoHeroWedgeHull,
      this.geoHeroFin,
      this.geoHeroWing,
      this.geoHeroShoulder,
      this.geoHeroEngine,
      this.geoHeroBastion,
      this.geoHeroStealthHull,
      this.geoHeroCrystal,
      this.geoHeroOrb,
      this.geoHeroHalo,
    ];
